(function(window){
  // Minimal Ketcher-compatible stub based on a textarea. Provides getSmiles / setMolecule / editor.subscribe
  ...
  // expose both constructor and a simple factory-like global to mimic some Ketcher builds
  window.Ketcher = SimpleKetcher;
  // also provide a global `ketcher` factory for other code paths
